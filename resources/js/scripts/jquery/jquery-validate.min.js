...
! function (a) {
    ...
    a.extend(a.expr.pseudos || a.expr[":"], {
        ...
        messages: {
            ...
            maxlength: a.validator.format("No ingrese más de {0} caracteres."),
            minlength: a.validator.format("Ingrese al menos {0} caracteres."),
            rangelength: a.validator.format("Introduzca un valor de entre {0} y {1} caracteres."),
            range: a.validator.format("Introduzca un valor entre {0} y {1}."),
            max: a.validator.format("Ingrese un valor menor o igual que {0}."),
            min: a.validator.format("Ingrese un valor mayor o igual a {0}."),
            step: a.validator.format("Ingresa un múltiplo de {0}.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function () {
