...
<div class="row d-flex justify-content-center">
    <div class="card col-12">
        ...
        <div class="card-content">
            <div class="card-body">
                <form action="{{route('documents.update', $documents->id)}}" id="validate" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <div class="row d-flex justify-content-center">
                                <div class="col-12 d-flex justify-content-center my-2"><label
                                        class="btn btn-primary btn-lg btn-block" for="mp4">{{ $documents->file }}</label>
                                </div>
                                <div class="col-12"><input type="file" name="file" id="mp4"
                                        class="file_multi_video form-control d-none"
                                        accept="video/mp4,video/x-m4v,video/*"></div>
                            </div>
                            <div class="row">
                                <div class="col-12 d-flex justify-content-center p-3"></div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-12 d-flex justify-content-center p-3"><video width="800" muted
                                            autoplay controls>
                                            <source src="{{ asset('storage/documents/'.$documents->file) }}"
                        id="preview_vid">Your browser does not support HTML5
                        video.</video>
                    </div>
            </div>
        </div>
    ...
    <div class="col-12 pdf mt-5">
        <input type="file" name="file" id="pdf" onchange="onUpload(this)" class="form-control d-none"
            accept="application/pdf">
        <div class="row">
            <div class="col-12 d-flex justify-content-center">
                <div class=" w-75" id="display-pdf">
                    <object data="{{ asset('storage/documents/'.$documents->file) }}" type="application/pdf" id="c_pdf"
                        width="100%" height="850px"></object>
                </div>
            </div>
        </div>
    </div>
