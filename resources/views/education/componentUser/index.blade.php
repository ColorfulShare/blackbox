            ...
            <div class="card container-fluid" style="width: 18rem;">
              <a href="/storage/education/{{$item->image}}" data-lightbox="image" data-title="Link : {{$item->link}}">
               ...
               <div class="card-body">
                ...
                <div class="pr-1 h3 pb-2 text text-white" id="shadow">
                  <div style="position: relative;" class="ml-1">{{$item->description}}</div>
                </div>
...
@section('vendor-script')
  ...
  <script src="{{ asset(mix('vendors/js/tables/datatable/dataTables.bootstrap5.min.js')) }}"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.11.3/js/lightbox.min.js"></script>
@endsection
